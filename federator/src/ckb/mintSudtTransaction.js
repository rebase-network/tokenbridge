...
const { scriptToHash, toHexInLittleEndian } = require('@nervosnetwork/ckb-sdk-utils')
 ...
 */
 function mintSudtRawTx(
    ...
    // 2. output | ckb charge
	const ckbCharge =
		BigInt(inputCkbCells.total) - BigInt(toSudtCapacity) - BigInt(fee)
	rawTx.outputs.push({
 ...
 const createSudtTransaction = async (
    ...
    const deps = [{"outPoint":{"txHash":"0xf8de3bb47d055cdf460d93a2a6e1b05f7432f9777c8c474abf4eec1d4aee5d37","index":"0x0"},"depType":"depGroup"},{"outPoint":{"txHash":"0xc1b2ae129fad7465aaa9acc9785f842ba3e6e8b8051d899defa89f5508a77958","index":"0x0"},"depType":"code"}];
